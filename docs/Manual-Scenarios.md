...
- [Manifest du scénario](#section-export-var-manifest)
- [Classe Scenario](#section-export-class-scenario)
  - [constructor](#constructor-obligatoire)
  - [enable](#enable-obligatoire)
  - [disable](#disable-obligatoire)
  - [start](#start-obligatoire)
- [Activation d'un scénario](#activation-dun-scénario)
- [Note sur sce_como_type1 (Audio)](#note-sur-sce_como_type1-audio)
- [Conseils](#conseils)

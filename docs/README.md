...
Version de la documentation: 1.3.0-dev — Voir aussi le fichier `CHANGELOG.md` à la racine du dépôt pour l'historique des versions.
...
- Scénario Comodale Type 1: [Manual-ComoType1](./Manual-ComoType1.md)
- Scénario Comodale Type 2: [Manual-ComoType2](./Manual-ComoType2.md)
